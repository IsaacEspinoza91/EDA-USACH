...
void main(){
    ...
    int nTablero = 0, cantPalabras = 0, resultadoFuncion;
    TDAGrafoMA *g = leer_tablero("tablero1.ini",&nTablero); 
    ...
    //resultadoFuncion = buscarPalabras(g, arrayPalabras[1], nTablero);
}

...
Salida: lista de lista de char (nombres leidos, lista 2D de palabras)*/
...
Salida: lista de lista de char, matriz lista de caracteres del tablero*/
...
Entrada: TDAlistaChar2D del tablero, TDAlistaChar plabra a buscar, int fila tablero,
...
bool buscarPalabras(TDAlistaChar2D tablero, TDAlistaChar palabra, int mFila, int nColumna, TDAlistaCoordenadas* listCoordenadas , FILE* archivo){
    ...
    //nodoCoordenadasPalabra* auxCoord = listCoord;
    while(auxiliar != NULL){
        nodo* aux2 = auxiliar->dato;
        columna = 0;
        while(aux2 != NULL){
            ...
            if(aux2->dato == palabra->dato){
                ...
                if((columna+largoPalabra-1) < nColumna){
                    ...
                    while(auxPalabra != NULL){
                        //printf(" if(   %c  comp  %c)\n",auxTablero1D->dato, auxPalabra->dato);
                ...
                if((fila+largoPalabra-1) < mFila){
                    ...
                    palabraEncontrada = true;
                    while(auxPalabra != NULL){
                        //printf(" if(   %c  comp  %c)\n",obtenerNodo(auxTablero2D->dato,columna)->dato, auxPalabra->dato);
                ...
                if( ((fila+largoPalabra-1) < mFila) && ((columna-largoPalabra+1) >= 0) ){
                    ...
                    palabraEncontrada = true;
                    while(auxPalabra != NULL){
                        //printf(" if(   %c  comp  %c)\n",obtenerNodo(auxTablero2D->dato,columna - numAux)->dato, auxPalabra->dato);
            ...
            if(aux2->dato == palabraReves->dato){
                ...
                if( ((fila+largoPalabra-1) < mFila) && ((columna-largoPalabra+1) >= 0) ){
                    ...
                    if(palabraEncontrada ==true){
                        ...
                        //printf(" Coordenadas (%i,%i)\n",fila+largoPalabra, columna-largoPalabra+2);
                ...
                if( ((fila+largoPalabra-1) < mFila) && ((columna+largoPalabra-1) < nColumna)){
                    ...
                    if(palabraEncontrada ==true){
                        //palabra ↘ reves encontrada
                        //printf(" Coordenadas (%i,%i)\n",fila+largoPalabra, columna+largoPalabra);
...
void main(){
    ...
    //recorrerLista2D(tablero);
    //recorrerLista2D(listaPalabras);
    //recorrerListaCoordenadas(listaCoordenadas);

...
//OPERACIONES
/*Funcion que crea una lista enlazada simple para posiciones (fila,columna)*/
...
/*Funcion que imprime los elementos char de una lista enlazada simple de coordenadas (fila,columna)
